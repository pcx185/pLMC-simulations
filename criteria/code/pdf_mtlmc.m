...
%modified tamed Langevin Monte Carlo (MTLMC) algorithm.
%======================================================================
...
Y1Euler = zeros(M,1);  % store all the data of the first component of the MTLMC algorithm.
...
yy1=hist(Y1Euler,x1);%计算各个区间的个数
yy1=yy1/length(Y1Euler);%计算各个区间的个数
%
bar(x1,yy1,'c');
hold on;

c3=plot (x1,yy1,'m-d', 'LineWidth',1.5);

s=0;
xlabel('Solutions of the modified Tamed Langevin Monte Carlo algorithm at T=6');
ylabel('probability density');

legend('probability (mTLMC)',' probability density')


title('Probability density for the modified Tamed Langevin algorithm  at T=6','FontSize',10);